...
.auth-brand { display: flex; align-items: center; gap: 0.65rem; justify-content: center; margin-bottom: 2.5rem; }
.brand-mark {
...
.auth-brand h1 { font-family: var(--font-display); font-size: 1.6rem; font-weight: 700; letter-spacing: -0.5px; }
.auth-card { background: var(--bg-card); border: 1px solid var(--border-color); border-radius: var(--radius-xl); padding: 2.25rem; }
.auth-card h2 { font-family: var(--font-display); font-size: 1.35rem; font-weight: 700; margin-bottom: 0.35rem; letter-spacing: -0.3px; }
.auth-sub { color: var(--text-muted); font-size: 0.85rem; margin-bottom: 1.75rem; }
.field { margin-bottom: 1.15rem; }
.field label { display: block; font-size: 0.78rem; font-weight: 500; color: var(--text-secondary); margin-bottom: 0.4rem; }
.field input, .input-box input {
  width: 100%; padding: 0.75rem 0.9rem; background: var(--bg-input);
  border: 1px solid var(--border-color); border-radius: var(--radius-md);
  color: var(--text-primary); font-size: 0.88rem; outline: none;
  transition: border-color 0.2s, box-shadow 0.2s;
}
.field input:focus, .input-box input:focus { border-color: rgba(206,255,0,0.35); box-shadow: 0 0 0 3px rgba(206,255,0,0.06); }
...
.err { color: #ff5c6c; font-size: 0.8rem; margin-bottom: 0.75rem; padding: 0.65rem; background: rgba(255,92,108,0.06); border-radius: var(--radius-sm); border: 1px solid rgba(255,92,108,0.1); }
.ok { color: var(--accent); font-size: 0.8rem; margin-bottom: 0.75rem; padding: 0.65rem; background: rgba(206,255,0,0.05); border-radius: var(--radius-sm); border: 1px solid rgba(206,255,0,0.1); }
.submit-btn {
  width: 100%; padding: 0.8rem; background: var(--accent); color: var(--bg-primary);
...
.spinner { width: 18px; height: 18px; border: 2px solid transparent; border-top-color: var(--bg-primary); border-radius: 50%; animation: spin 0.5s linear infinite; }
